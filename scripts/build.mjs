...
const sourceFiles = ["background.js", "browser-adapter.js", "tab-manager.js"];
...
async function buildTarget(target) {
  ...
  await cp(join(source, "core"), join(out, "core"), { recursive: true });
  await cp(join(source, "popup"), join(out, "popup"), { recursive: true });
  ...
  await copyIfNeeded(join(source, "assets/icon.svg"), join(out, "assets/icon.svg"));
